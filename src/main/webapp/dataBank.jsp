        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="#dataBank" data-toggle="tab" aria-expanded="false">
                            <span class="visible-xs"><i class="fa fa-user"></i></span>
                            <span class="hidden-xs">知识库</span>
                        </a>
                    </li>
                    <li class="">
                        <a href="#uploadFiles" data-toggle="tab" aria-expanded="true">
                            <span class="visible-xs"><i class="fa fa-home"></i></span>
                            <span class="hidden-xs">发布资料</span>
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="uploadFiles">
                        <div class="row">
                            <%--enctype="multipart/form-data" 表示提交的数据是二进制的--%>
                            <form action="uploadFiles.action" method="post" enctype="multipart/form-data"
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="password-field-1" class="col-md-1 control-label">标题</label>
                                                <div class="col-md-11">
                                                    <input type="text" class="form-control" id="filesTitle"
                                                           name="filesTitle" onblur="checkFileName()">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="password-field-1"
                                                       class="col-md-1 control-label">描述</label>
                                                <div class="col-md-11">
                                                    <textarea class="form-control" rows="5"
                                                              name="filesDescribe" id="filesDescribe"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="password-field-3"
                                                       class="col-sm-1 control-label">选择文件</label>
                                                <div class="col-sm-3">
                    ...
                    <!-- 知识库 -->
                    <div class="tab-pane active" id="dataBank">
                        <div class="row">
                            <div class="col-md-12">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < obj.files.length; i++) {
                    ...
                    var tr = $('<tr></tr>');
                    // 日期处理
                    var utDate = new Date(val.filesTime);
                    // 链接
                    var aFileName = '<a href=\"/Gotc/downloadFiles.action?fn=' + val.filesName + '\">' + val.filesName + '</a>';
                    tr.append('<td>' + val.id + '</td>' + '<td>' + (val.filesTitle == null ? "" : val.filesTitle) + '</td>' + '<td>' + aFileName + '</td>' + '<td>' + (val.filesDescribe == null ? "" : val.filesDescribe) + '</td>' + '<td>' + val.filesType + '</td>' + '<td>' + (val.filesPosterName == null ? "" : val.filesPosterName) + '</td>' + '<td>' + utDate.format("yyyy-mm-dd") + '</td>');
                    tbody.append(tr);
                }
