        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-sm-11"><h3 class="panel-title">用户列表</h3></div>
                            <div class="col-sm-1 text-right">
                                <button id="addToTable" class="btn btn-primary waves-effect waves-light"><i
...
<script type="text/javascript">
    ...
    function itemOnclick(target) {
        ...
        // var tree = $('#tree');   // 为啥不是 id =  treeview
        // //获取当前节点对象
    ...
    function initTreeView() {
        $.ajax({
            ...
            success: function (data) {
                ...
                for (i = obj.department.length - 1; i > 0; i--) {
                    val = obj.department[i];
                    k = obj.department.length - i;
                    defaultData += "{text:\'" + val.deptName + "\',href:\'#parent" + k + "\',tags:[\'" + i + "\']},";
                }
                val = obj.department[i];
                k = obj.department.length - i;
                defaultData = defaultData + "{text:'" + val.deptName + "',href:'#parent" + k + "',tags:['" + i + "']}";
    ...
    function initTable() {
        $.ajax({
            ...
            success: function (obj) {
                ...
                //     var tr = $('<tr></tr>');
                //     var k = i + 1;
                //     tr.append('<td>' + val.empName + '</td>' + '<td>' + val.empRole + '</td>' + '<td>' + val.empDeptNo + '</td>'
                ...
                //     tbody.append(tr);
                // }
                // $('#datatable-editable tbody').replaceWith(tbody);
            },
            error: function () {
                // alert("error");
            }
