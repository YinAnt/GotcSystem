...
<head>
    ...
    <link href="assets/jquery-datatables-editable/datatables.css" rel="stylesheet"/>
            ...
            <div class="col-lg-12">
                <div class="tabs-vertical-env">
                    <ul class="nav tabs-vertical">
                        <li class="active">
                            <a href="#v-admin" data-toggle="tab" aria-expanded="true">管理员</a>
                        </li>
                        <li class="">
                            <a href="#v-tester" data-toggle="tab" aria-expanded="false">测试人员</a>
                        </li>
                        <li class="">
                            <a href="#v-normal" data-toggle="tab" aria-expanded="false">普通用户</a>
                        </li>
                        <li class="">
                            <a href="#v-other" data-toggle="tab" aria-expanded="false">其他人员</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="panel">
                                    <div class="panel-body">
                                        <table id="myTable-admin" class="table table-bordered table-striped">
                                            <thead>
                                            <tr>
                                                <th>姓名</th>
                                                <th>角色</th>
                        ...
                        <div class="tab-pane" id="v-tester">
                            <div class="row">
                                <div class="panel">
                                    <div class="panel-body">
                                        <table id="myTable-tester" class="table table-bordered table-striped">
                                            <thead>
                                            <tr>
                                                <th>姓名</th>
                                                <th>角色</th>
                        ...
                        <div class="tab-pane" id="v-normal">
                            <div class="row">
                                <div class="panel">
                                    <div class="panel-body">
                                        <table id="myTable-normal" class="table table-bordered table-striped">
                                            <thead>
                                            <tr>
                                                <th>姓名</th>
                                                <th>角色</th>
                        ...
                        <div class="tab-pane" id="v-other">
                            <div class="row">
                                <div class="panel">
                                    <div class="panel-body">
                                        <table id="myTable-other" class="table table-bordered table-striped">
                                            <thead>
                                            <tr>
                                                <th>姓名</th>
                                                <th>角色</th>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < obj.employee.length; i++) {
                    ...
                    var tr = $('<tr></tr>');
                    var k = i + 1;
                    tr.append('<td>' + k + '</td>' + '<td>' + val.empName + '</td>' + '<td>' + val.empRole + '</td>' + '<td>' + val.empDeptNo + '</td>');
                    tbody.append(tr);
                }
                $('#myTable-admin tbody').replaceWith(tbody);
            }
        });
    });
</script>
