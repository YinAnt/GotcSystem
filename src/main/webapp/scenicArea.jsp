...
<%--景区--%>
<div class="container">
    <div class="scenic-horizontal-center">
        <div class="scenic-horizontal" id="div-scenic">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < maxNum; i++) {
                    ...
                    var text1 = '<div class="row">' + '<div class="scenic-horizontal">' + '<div class="col-md-5 text-right">' + '<div class="scenic-horizontal-top wow fadeInLeft animated" data-wow-delay=".1s">';
                    var text2 = '<img src="' + val.scnImgPath + '" class="img-responsive" alt=""></a></div></div>';
                    var text3 = '<div class="col-md-7 text-left">' + '<div class="scenic-horizontal-down wow fadeInRight animated" data-wow-delay=".1s">';
                    var text4 = '<a href="" >' + '<h3 class="text-center">' + val.scnName + '</h3></a><p>' + val.scnDescribe + '</p>\t</div>\n' + '</div>' + '</div>' + '</div>';
