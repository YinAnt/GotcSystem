...
<div class="container">
    <div class="introduce">
        <div>
            <h3>桂林国际旅游胜地欢迎您</h3>
            <p>桂林，人口530余万人，面积达2.78万平方公里。年均气温16.5℃-20.5℃，森林覆盖率66.5％，雨量充沛、环境优美、空气清新，被誉为最适合人类休闲、旅游、居住的地方。是首批国家历史文化名城，是具有万年历史的人类智慧圣地，是中华文明重要的发源地，新石器时代就有人类的生存和繁衍。因桂花成林而得名。</p>
            <p>桂林，地处湘桂走廊南端，北接湖南、贵州，西南连柳州，东邻贺州，属山地丘陵地区及典型喀斯特岩溶地貌，遍布全市的石灰岩经亿万年风化浸蚀，形成千峰环立，一水抱城，洞奇石美独特景观。桂林山水以“山清、水秀、洞奇、石美”著称，桂历来有“山水甲天下”之誉，是我国重点风景游览城市和园林城市，又是国务院命名的第一批历史文化名城。2003年，世界旅游组织将桂林与北京、上海、西安一起列为中国最佳旅游城市，向世界旅游者郑重推荐。</p>
        </div>
    </div>
    <hr>
</div>
...
<!-- 景点 -->
<div class="container" id="div-scenic">
...
<div class="container">
    <hr>
    <div class="row">
        <h3 style="text-align: center;color: #34ad00;height: 2em;">导游介绍</h3>
    </div>
    <div class="row" id="div-guide">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <!-- TODO 描述+文本框 比例不协调 -->
                                <label for="WriteUs-field-5" class="col-sm-2 text-center">描述</label>
                                <div class="col-sm-10">
    ...
    function getScenic() {
        $.ajax({
            ...
            success: function (data) {
                // alert("success");
                var obj = eval(data);
                // var maxNum = obj.scenic.length;
                var maxNum = (obj.scenic.length > 10 ? 10 : obj.scenic.length);
                for (var i = 0; i < maxNum; i++) {
                    var val = obj.scenic[i];
                    var text1 = '<div class="scenic"><div class="scenic-top wow fadeInLeft animated" data-wow-delay=".1s">';
                    var text2 = '<img src="' + val.scnImgPath + '" class="img-responsive" alt=""></a></div>';
                    var text3 = '<div class="scenic-down wow fadeInRight animated" data-wow-delay=".1s">';
                    var text4 = '<a href="" ><h3>' + val.scnName + '</h3></a><p>' + val.scnNoteTag + '</p></div></div>';

                    var divScenic = document.getElementById("div-scenic");
                    divScenic.innerHTML = divScenic.innerHTML + text1 + text2 + text3 + text4;
                }
            },
            error: function () {
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < maxNum; i++) {
                    ...
                    var text1 = '<div class="col-md-4"><div class="guide"><div class="guide-left wow zoomIn animated" data-wow-delay=".2s" >';
                    var text2 = '<img src="' + 'images/timg' + (i + 1) + '.jpg' + '"></div>';
                    var text3 = '<div class="guide-right wow zoomIn animated" data-wow-delay=".2s">';
                    var text4 = '<h3>' + val.empName + '</h3><p>' + val.empNoteTag + '</p></div></div></div>';
