...
public interface OrdersDAO {
    ...
    List<Orders> doFindPayedDesc() throws SqlException; // 查询所有 已付款的  订单记录（时间降序）
    ...
    Orders addOrdComment(Long ordNo,String ordComment) throws SqlException; // 添加订单评价
    Orders addOrdReply(Long ordNo,String ordReply) throws SqlException; // 添加订单评价的客服回复
}
